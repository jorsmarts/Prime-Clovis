...
.site-navbar{
  ...
  background:rgba(43,51,64,0.85);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);
  border-radius:16px;margin-top:0;overflow:visible;
  transition:background .3s,box-shadow .3s,border-radius .3s;
}
.site-navbar.scrolled{
  background:rgba(43,51,64,0.98);box-shadow:0 4px 20px rgba(0,0,0,.15);
...
.nav-menu{display:flex;align-items:center;gap:40px;list-style:none;margin:0;padding:0;flex:1;justify-content:center;}
.nav-menu>li{position:relative;}
.nav-menu>li>a{display:flex;align-items:center;gap:6px;color:rgba(255,255,255,.90);text-decoration:none;font-size:15px;font-weight:600;padding:8px 0;white-space:nowrap;transition:color .2s;}
.nav-menu>li>a:hover,.nav-menu>li.active>a{color:#d4f000;}
.drop-icon{width:14px;height:14px;stroke:currentColor;fill:none;stroke-width:2.5;flex-shrink:0;transition:transform .25s;}
.has-drop:hover .drop-icon{transform:rotate(180deg);}
.drop-menu{
  position:absolute;top:calc(100% + 8px);left:50%;
  transform:translateX(-50%) translateY(-6px);
  background:rgba(30,36,50,.98);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);
  border-radius:12px;padding:10px 0;min-width:220px;list-style:none;margin:0;
  box-shadow:0 8px 32px rgba(0,0,0,.30);
  opacity:0;visibility:hidden;pointer-events:none;
  transition:opacity .28s,transform .28s,visibility .28s;z-index:200;
}
.drop-menu::before{content:'';position:absolute;top:-6px;left:50%;transform:translateX(-50%);border-left:8px solid transparent;border-right:8px solid transparent;border-bottom:6px solid rgba(30,36,50,.98);}
...
.drop-menu a{display:flex;align-items:center;gap:8px;color:rgba(255,255,255,.85);text-decoration:none;font-size:13.5px;font-weight:500;padding:10px 22px;white-space:nowrap;transition:background .15s,color .15s,padding-left .18s;}
.drop-menu a:hover{background:rgba(212,240,0,.10);color:#d4f000;padding-left:28px;}
.nav-cta{background:#d4f000!important;color:#1e2432!important;font-weight:800!important;padding:10px 22px!important;border-radius:8px!important;transition:background .2s,transform .2s,box-shadow .2s!important;}
.nav-cta:hover{background:#c5e000!important;color:#1e2432!important;transform:translateY(-1px);box-shadow:0 4px 16px rgba(212,240,0,.35)!important;}
...
.bf-honey{display:none!important;visibility:hidden!important;position:absolute;left:-9999px;}
...
.cs-text{min-width:0;overflow:hidden;}
.cs-text span{display:block;font-size:11px;color:#9ca3af;font-weight:500;margin-bottom:2px;}
.cs-text strong{display:block;font-size:13px;color:#2b3340;font-weight:700;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
...
.footer-wrap{
  ...
  background:#2b3340;
  border-radius:20px;padding:64px 48px 32px;
  box-shadow:0 4px 32px rgba(43,51,64,.22);
}
.footer-top{display:grid;grid-template-columns:2fr 1fr 1fr 1.4fr;gap:48px;padding-bottom:48px;border-bottom:1px solid rgba(255,255,255,.08);margin-bottom:28px;}
.footer-logo-img{height:52px;width:auto;display:block;object-fit:contain;margin-bottom:18px;}
.footer-desc{font-size:13px;color:rgba(255,255,255,.55);line-height:1.75;margin:0 0 22px;}
.footer-socials{display:flex;gap:10px;}
.footer-socials a{width:36px;height:36px;border-radius:50%;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);display:flex;align-items:center;justify-content:center;transition:background .2s,border-color .2s;text-decoration:none;}
.footer-socials a:hover{background:#445162;border-color:#445162;}
.footer-socials svg{width:15px;height:15px;stroke:rgba(255,255,255,.70);fill:none;stroke-width:2;transition:stroke .2s;}
.footer-socials a:hover svg{stroke:#fff;}
.footer-socials a.fill-icon svg{fill:rgba(255,255,255,.70);stroke:none;}
...
.footer-contact-list svg{width:15px;height:15px;stroke:#d4f000;fill:none;stroke-width:2;flex-shrink:0;margin-top:2px;}
...
@media(max-width:1024px){
  ...
  .footer-wrap{max-width:100%;border-radius:0;box-shadow:none;padding:56px 24px 32px;}
...
@media(max-width:768px){
  ...
  .nav-menu{
    ...
    background:rgba(43,51,64,.98);backdrop-filter:blur(12px);
    border-radius:0 0 16px 16px;
  ...
  .nav-menu.open{opacity:1!important;visibility:visible!important;transform:translateY(0)!important;pointer-events:auto!important;}
  .nav-menu>li{width:100%;border-bottom:1px solid rgba(255,255,255,.10);}
  .nav-menu>li:last-child{border-bottom:none;}
  .nav-menu>li>a{padding:14px 4px;font-size:15px;width:100%;justify-content:space-between;min-height:48px;}
  .drop-menu{position:static!important;transform:none!important;opacity:1!important;visibility:visible!important;box-shadow:none;background:rgba(28,35,46,.92);border-radius:8px;border-left:3px solid #d4f000;padding:4px 0;pointer-events:auto;display:none;margin:0!important;}
  .drop-menu.mob-open{display:block;margin-top:2px!important;padding:4px 0 12px!important;}
  .drop-menu::before{display:none!important;}
  .drop-menu a{padding:12px 16px 12px 28px;font-size:14px;min-height:44px;}
  ...
  .footer-top{display:flex!important;flex-direction:column!important;gap:28px;padding-bottom:28px;margin-bottom:20px;}
  ...
  <div class="cal-contact-grid">
    <div style="min-width:0;overflow:hidden;">
      ...
      <div style="display:flex;flex-direction:column;gap:16px;">
        <div style="display:flex;align-items:flex-start;gap:12px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:14px 16px;overflow:hidden;width:100%;box-sizing:border-box;">
          <div style="width:36px;height:36px;border-radius:10px;background:rgba(212,240,0,.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
            <svg viewBox="0 0 24 24" width="16" height="16" style="stroke:#2b3340;fill:none;stroke-width:2;"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8 19.79 19.79 0 010 2.18 2 2 0 012 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92z"/></svg>
          </div>
          <div style="min-width:0;overflow:hidden;"><div style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;letter-spacing:.8px;margin-bottom:3px;">Phone</div><a href="tel:{PHONE_RAW}" style="font-size:16px;font-weight:800;color:#2b3340;text-decoration:none;display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">{PHONE}</a></div>
        </div>
        <div style="display:flex;align-items:flex-start;gap:12px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:14px 16px;overflow:hidden;width:100%;box-sizing:border-box;">
          <div style="width:36px;height:36px;border-radius:10px;background:rgba(68,81,98,.10);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
            <svg viewBox="0 0 24 24" width="16" height="16" style="stroke:#2b3340;fill:none;stroke-width:2;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
          </div>
          <div style="min-width:0;overflow:hidden;"><div style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;letter-spacing:.8px;margin-bottom:3px;">Email</div><a href="mailto:{EMAIL}" style="font-size:13px;font-weight:700;color:#2b3340;text-decoration:none;display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">{EMAIL}</a></div>
        </div>
        <div style="display:flex;align-items:flex-start;gap:12px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:14px 16px;overflow:hidden;width:100%;box-sizing:border-box;">
          <div style="width:36px;height:36px;border-radius:10px;background:rgba(37,211,102,.12);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
            <svg viewBox="0 0 24 24" width="16" height="16" style="stroke:#2b3340;fill:none;stroke-width:2;"><path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"/></svg>
          </div>
          <div style="min-width:0;overflow:hidden;"><div style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;letter-spacing:.8px;margin-bottom:3px;">WhatsApp</div><a href="https://wa.me/message/7XVFDXQTK2XSP1" target="_blank" style="font-size:14px;font-weight:700;color:#2b3340;text-decoration:none;">Click to Chat</a></div>
        </div>
        <div style="display:flex;align-items:flex-start;gap:12px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:14px 16px;overflow:hidden;width:100%;box-sizing:border-box;">
          <div style="width:36px;height:36px;border-radius:10px;background:rgba(68,81,98,.08);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
            <svg viewBox="0 0 24 24" width="16" height="16" style="stroke:#2b3340;fill:none;stroke-width:2;"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
          </div>
          <div style="min-width:0;overflow:hidden;"><div style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;letter-spacing:.8px;margin-bottom:3px;">Hours</div><span style="font-size:14px;font-weight:700;color:#2b3340;">Mon–Sat: 7:00 AM – 7:00 PM</span></div>
        </div>
        <div style="display:flex;align-items:flex-start;gap:12px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:14px 16px;overflow:hidden;width:100%;box-sizing:border-box;">
          <div style="width:36px;height:36px;border-radius:10px;background:rgba(239,68,68,.08);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
            <svg viewBox="0 0 24 24" width="16" height="16" style="stroke:#2b3340;fill:none;stroke-width:2;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
          </div>
          <div style="min-width:0;overflow:hidden;"><div style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;letter-spacing:.8px;margin-bottom:3px;">Service Area</div><span style="font-size:14px;font-weight:700;color:#2b3340;overflow-wrap:break-word;">Fresno, Clovis, Madera, Sanger, Fowler, Friant</span></div>
        </div>
      </div>
    </div>
    <div style="min-width:0;">
      <div class="cal-card">
        ...
        <p class="cal-card-sub">Choose a date, preferred time, and fill in your details.</p>
        <form id="bookingForm">
          <div class="bf-honey"><label>Leave blank<input type="text" name="website" tabindex="-1" autocomplete="off"></label></div>
          ...
          <div class="cal-fields">
            ...
            <div class="bf-group"><label>Phone Number *</label><input type="tel" name="phone" placeholder="(559) 000-0000" required></div>
            <div class="bf-group"><label>Zip Code / Address</label><input type="text" name="address" placeholder="e.g. 93612 or 123 Main St, Fresno"></div>
...
.cal-wrap {{ border:1px solid #e5e7eb; border-radius:12px; overflow:hidden; margin-bottom:20px; }}
...
.cal-day:hover:not(.cal-empty):not(.cal-past) {{ background:#d4f000; color:#1e2432; }}
...
.cal-day.cal-past {{ color:#d1d5db; cursor:default; pointer-events:none; }}
.cal-day.cal-empty {{ cursor:default; }}
.cal-fields {{ display:flex; flex-direction:column; gap:12px; border-top:1px solid #e5e7eb; padding-top:18px; }}
.cal-fields .bf-group {{ margin-bottom:0; }}
.cal-contact-grid {{ display:grid; grid-template-columns:1fr 420px; gap:52px; align-items:start; width:100%; box-sizing:border-box; }}
.cal-card {{ background:#fff; border:1px solid #e5e7eb; border-radius:16px; padding:32px; width:100%; box-sizing:border-box; min-width:0; }}
@media(max-width:768px) {{
  .cal-contact-grid {{ grid-template-columns:1fr !important; gap:24px !important; }}
  .cal-card {{ padding:18px 14px; width:100% !important; max-width:100% !important; box-sizing:border-box !important; overflow:hidden; }}
  .cal-day {{ padding:8px 2px; font-size:12px; }}
  .section-outer {{ overflow-x:hidden; }}
  .section-box {{ padding:28px 16px !important; }}
}}
</style>
<script>
(function(){{
  ...
  function render(){{
    ...
    var sel=document.getElementById('calDateVal').value;
    var html='';
    ...
    for(var d=1;d<=days;d++){{
      ...
      var lbl=months[dt.getMonth()]+' '+dt.getDate()+', '+dt.getFullYear();
      if(sel===lbl) cls+=' cal-selected';
      html+='<div class="'+cls+'" data-label="'+lbl+'">'+d+'</div>';
    }}
    grid.innerHTML=html;
    grid.querySelectorAll('.cal-day:not(.cal-empty):not(.cal-past)').forEach(function(el){{
