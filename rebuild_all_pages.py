...
<div class="section-outer">
<div class="section-box">
  <div class="cal-contact-grid" style="display:grid;grid-template-columns:1fr 420px;gap:52px;align-items:start;">
    <div>
...
@media(max-width:768px) {{
  .cal-contact-grid {{ grid-template-columns:1fr !important; gap:32px !important; }}
